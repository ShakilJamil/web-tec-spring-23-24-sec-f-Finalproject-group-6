...
$rname=$_POST['searchParcel'];

$users = getSpecificParcelHistory($rname);
?>
...
<body>
    <form action="specificParcel.php" method="POST">
        ...
        <table border="1" cellspacing="0" width="100%" cellpadding="10" height="400px">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../view/EditParcelUser.php?IdParcel=<?php echo $users[$i]['parcelID'] ?>" name="edit"
                            style="color: Green; font-size:22px;"><i class="fa-solid fa-pen-to-square"></i></a>
                    </td>
                    <td>
                        <a href="../view/deleteparcel.php?IdParcel=<?php echo $users[$i]['parcelID'] ?>" name="delete"
        ...
        <table align="center" border="a" cellspacing="0" cellpadding="5">
            <tr>
                <td align="center">
                    <a href="../view/Memberdashboard.php">Back to Home!?</a>
                </td>
            </tr>
        </table>
