...
<html>
    ...
    <div class="wrapper">
        <span class="icon-close"><a href="index.php"><ion-icon name="close"></a></ion-icon></span>
    <div class="form-box login">
        <h2>Login</h2>
        <form onsubmit="return IsvalidForm()" method="post" action="../controller/LoginChecker.php" enctype="">
            <div class="input-box">
                <span class="icon"><ion-icon name="mail"></ion-icon></span>
                <input type="text" name="email" id="lemail" onkeyup="isValidEmail()" value="<?php echo $Email ?>"></br><small id = "EmailError" style="color: white;"></small>
                <label>Email</label>
            </div>
            <div class="input-box">
                <span class="icon"><ion-icon name="lock-closed"></ion-icon></ion-icon></span>
                <input type="password"name="password" id="password" onkeyup="isValidPassword()" value="<?php echo $Password ?>"></br><small id = "PassError" style="color:white"></small>
