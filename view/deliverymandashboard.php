...
<body>
    <form action="">
        ...
        <table border="1" cellspacing="0" width="100%" cellpadding="10" height="630px">
            <tr>
                <td><img src="../asset/clogo.png" alt="" height="30px" ><b>Quick Egale Currier Service</td>
            ...
            <tr>
                <td>
                    <a href="total_earning.php">Total Earning</a>
                </td>
            </tr>

            <tr>
                <td>
                    <a href="receiver_info.php">Receiver Information</a>
                </td>
            </tr>

            <tr>
                <td>
                    <a href="current_parcel_info.php">Current Parcel Information</a>
                </td>
            </tr>
